package com.assambra.ezyfoxcluster.plugin;

import com.assambra.ezyfoxcluster.common.constant.CommonConstants;
...
public class PluginEntry extends EzyDefaultPluginEntry {
    ...
    protected void preConfig(EzyPluginContext ctx) {
        logger.info("\n=================== ezyfox-cluster PLUGIN START CONFIG ================\n");
    }

    @Override
    protected void postConfig(EzyPluginContext ctx) {
        logger.info("\n=================== ezyfox-cluster PLUGIN END CONFIG ================\n");
    }

    @Override
    protected void setupBeanContext(EzyPluginContext context, EzyBeanContextBuilder builder) {
        EzyPluginSetting setting = context.getPlugin().getSetting();
        builder.addProperties("ezyfox-cluster-common-config.properties");
    ...
    protected String[] getScanablePackages() {
        return new String[]{
            "com.assambra.ezyfoxcluster.common",
            "com.assambra.ezyfoxcluster.plugin"
        };
    }
}
