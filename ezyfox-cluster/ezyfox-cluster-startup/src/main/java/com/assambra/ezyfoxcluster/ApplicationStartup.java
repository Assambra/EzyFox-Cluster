package com.assambra.ezyfoxcluster;

import com.assambra.ezyfoxcluster.plugin.PluginEntry;
import com.assambra.ezyfoxcluster.plugin.PluginEntryLoader;
import com.assambra.ezyfoxcluster.app.AppEntry;
import com.assambra.ezyfoxcluster.app.AppEntryLoader;
        ...
        public EzyPluginEntry load() throws Exception {
            return new PluginEntry() {
                ...
                private String getPluginPath(EzyPluginSetting setting) {
                    Path pluginPath = Paths.get("ezyfox-cluster-plugin");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../ezyfox-cluster-plugin");
                    }
        ...
        public EzyAppEntry load() throws Exception {
            return new AppEntry() {
                ...
                private String getAppPath() {
                    Path pluginPath = Paths.get("ezyfox-cluster-app-entry");
                    if (!Files.exists(pluginPath)) {
                        pluginPath = Paths.get("../ezyfox-cluster-app-entry");
                    }
                    return pluginPath.toString();
                }
            };
